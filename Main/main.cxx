...
#include "../Viewer/oculusviewer.h"
#include "../Viewer/oculusdevice.h"
#include "../Viewer/oculuseventhandler.h"
...
extern osg::ref_ptr<OculusViewer> oculusViewer;
extern osg::ref_ptr<OculusDevice> oculusDevice;
//end
...
static void fgMainLoop( void )
{
	...
	//osg::ref_ptr<osg::Group> loadedModel = globals->get_renderer()->getViewerSceneRoot();
...
static void fgIdleFunction ( void ) {
    ...
    if ( idle_state == 1000 ) {
		...
		//viewer->getCamera()->setRenderer(globals->get_renderer());

		printf("idle_state = 888\r\n");
		oculusViewer->addChild(loadedModel);
		printf("idle_state = 999\r\n");
		viewer->setSceneData(oculusViewer);

		printf("idle_state = 1000\r\n");
    }
    
    if ( idle_state == 2000 ) {
        fgStartNewReset();
        idle_state = 2005;
		printf("idle_state = 2000\r\n");
    }
}
